      ...
      <nav className="site-nav">
        <div className="container">
          <div className="site-navigation">
            <Link to="/Index" className="logo m-0"></Link>
        ...
        <div className="container">
          ...
          <div className="owl-carousel owl-3-slider">
            ...
            <div className="item">
              <a
                className="media-thumb"
                href="Assets/images/hero-slider-4.jpg"
                data-fancybox="gallery"
              >
                <div className="media-text">
                  <h3>Rialto Bridge</h3>
                ...
                <img
                  src="Assets/images/hero-slider-4.jpg"
                  alt="Image"
                  className="img-fluid"
                />
              </a>
            ...
            <div className="item">
              <a
                className="media-thumb"
                href="Assets/images/hero-slider-5.jpg"
                data-fancybox="gallery"
              >
                <div className="media-text">
                ...
                <img
                  src="Assets/images/hero-slider-5.jpg"
                  alt="Image"
                  className="img-fluid"
                />
              </a>
